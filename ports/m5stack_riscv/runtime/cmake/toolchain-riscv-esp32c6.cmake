#
#  CMake toolchain file for the ESP32-C6 (RISC-V RV32IMAC, single core).
#
...
#
#  Shape: dev fmp3_esp_idf_dev c7fef18 cmake/toolchain-riscv-esp32c6.cmake,
#  which is the sibling of ports/m5stack_xtensa/runtime/cmake/
#  toolchain-xtensa-esp32s3.cmake. -march/-mabi/-mcmodel/specs are not set
#  here: they are the chip layer's decision (arch/riscv_gcc/esp32c6/chip.cmake).
#
...
#
#  Pin the toolchain build at configure time. The C6 port was brought up with
...
execute_process(COMMAND ${CMAKE_C_COMPILER} --version
                OUTPUT_VARIABLE _c6_gcc_version ERROR_QUIET)
if(NOT _c6_gcc_version MATCHES "esp-14\\.2\\.0_20260121")
    message(FATAL_ERROR
        "The ESP32-C6 stage is built with riscv32-esp-elf esp-14.2.0_20260121 "
        "(M5Stack core tools/esp-rv32/2601).\n"
        "  gcc found on PATH: ${_c6_gcc_version}\n"
        "  Run scripts/build_prebuilt_stages.py --chip esp32c6, which puts the "
