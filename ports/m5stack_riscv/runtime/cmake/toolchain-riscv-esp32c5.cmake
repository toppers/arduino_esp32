#
#  CMake toolchain file for the ESP32-C5 (RISC-V RV32IMAC, single core, CLIC).
#
...
#
#  Shape: dev fmp3_esp_idf_dev 1d96bcba cmake/toolchain-riscv-esp32c5.cmake,
...
#  here: they are the chip layer's decision (arch/riscv_gcc/esp32c5/chip.cmake).
#
...
#
#  Pin the toolchain build at configure time. The C5 port was brought up with
...
execute_process(COMMAND ${CMAKE_C_COMPILER} --version
                OUTPUT_VARIABLE _c5_gcc_version ERROR_QUIET)
if(NOT _c5_gcc_version MATCHES "esp-14\\.2\\.0_20260121")
    message(FATAL_ERROR
        "The ESP32-C5 stage is built with riscv32-esp-elf esp-14.2.0_20260121 "
        "(M5Stack core tools/esp-rv32/2601).\n"
        "  gcc found on PATH: ${_c5_gcc_version}\n"
        "  Run scripts/build_prebuilt_stages.py --chip esp32c5, which puts the "
