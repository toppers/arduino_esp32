...
/*
 *  タイマドライバ（M5NanoC6 / ESP32-C6 用・FMP3・esp-hal LL層版）
 *  SYSTIMER（unit0＋target0コンパレータ）を使用して高分解能タイマを
 *  実現する．出典: asp3_esp_idf asp3/target/esp32c6_espidf/target_timer.c。
 *  診断用カウンタ（esp32c6_hrt_set_event_*・g_hrt_last_target・
