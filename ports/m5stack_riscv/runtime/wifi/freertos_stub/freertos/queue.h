 ...
 *  SD/SPI で実機ハング 4 run を費やした H4（`.steering/20260803-lx6-sd-h4/`）と同型。
 *
 ...
 *  `.steering/20260803-h4-stale-ar-hypothesis/`）。⇒ **無条件写像**にする。
 ...
 *    生ログ: `.steering/20260804-bthal-ring/logs/01-ble-objs-queue-refs.txt`
 *
