...
/*
 *  BT-4最終検証で発見（2026-07-10、steering §13）：本定義が無いと
 ...
 *  （30秒）後に切断する（実測：全接続でServicesResolvedが+30.0秒→
 *  2秒後にcentral起点切断）。IDF Kconfig既定はBT_NIMBLE_GATT_SERVER=y／
...
/*  S3固有の既知バグ回避（BT-4調査、2026-07-09）：ble_gap_slave_adv_reattempt()が
