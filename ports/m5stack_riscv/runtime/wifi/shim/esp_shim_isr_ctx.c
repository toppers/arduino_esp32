 ...
 *  ========================================================================
 *  レビュー（`.steering/20260803-main-review/README.md` A-2）は
 ...
 *    （手順と全出力: `.steering/20260803-t3-osi-ectx/blob-osi-usage.txt`）。
 ...
 *  最後の実測値は 0（`.steering/20260814-deltsk-measure/logs/run{1,2}-*.txt`
