# -*- coding: utf-8 -*-
#
#		パス2の生成スクリプトのターゲット依存部（無印ESP32 / LX6用）
#
#  内容は target/esp32s3_devkitc_gcc/target_kernel.py と同一である
#    （元の .trb 同士がバイト同一なので .py も同一に保つ）。
#
...
#  ため（非公開作業記録/20260706-arch-bringup/design.md 参照）、それらの生成コードは
#  持たない。
#
