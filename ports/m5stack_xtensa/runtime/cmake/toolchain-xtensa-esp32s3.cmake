#
#  ESP32-S3（Xtensa LX7）用 CMake ツールチェーンファイル
#
#  使い方:
#    cmake -S <repo>/fmp3_core -B <build> -G Ninja \
#      -DCMAKE_TOOLCHAIN_FILE=<repo>/cmake/toolchain-xtensa-esp32s3.cmake \
#      -DFMP3_TARGET=esp32s3_devkitc_gcc \
#      -DFMP3_TARGET_DIR=<repo>/target/esp32s3_devkitc_gcc \
#      -DFMP3_LIBRARY_ONLY=ON -DFMP3_PRC_NUM=1
#
#  ★FMP3_EXPECTED_TOOLCHAIN_MACHINE は "xtensa-esp-elf" である（"xtensa-esp32s3-elf"
#    ではない）。esp-14.2.0 の xtensa-esp32s3-elf-gcc は xtensa-esp-elf-gcc への
...
if(NOT DEFINED XTENSA_TOOLCHAIN_PREFIX)
    set(XTENSA_TOOLCHAIN_PREFIX xtensa-esp32s3-elf-)
endif()
